...
class DatasetFetcher:
    ...
    def download_dataset(self, hq_files=True):
        ...
        files = ["train.zip", "test.zip", "metadata.csv.zip",
                 "train_masks.csv.zip", "train_masks.zip"]
        datasets_path = [destination_path + "boneage-training-dataset", destination_path + "boneage-test-dataset",
                         destination_path + "boneage-test-dataset.csv", destination_path + "boneage-training-dataset.csv",
